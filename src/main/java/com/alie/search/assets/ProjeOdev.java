...
public class ProjeOdev {
    public HashMap<String, Integer> run(String keyw) {
        ...
        HashMap<String, Integer> hm = new Arama().AramaFunction(HashTable, keyw, tableSize); //girilen kelimeyi arayan fonksiyon
